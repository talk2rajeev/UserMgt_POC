           ...
           <div className="col-md-8">
                ...
                <div className="top-margin10 row">
                    <div className="col-md-6">
                        ...
                        <input type="number" id="at_h" style={{'width':'70px'}} min="0" name="AccessTokenLifeTime_hh" placeholder="hh" onChange={(event)=>props.inputChangeHandler(event)} className="form-control1 required"/>
                        &nbsp;<input type="number" id="at_m" style={{'width':'70px'}} min="0" name="AccessTokenLifeTime_mm" placeholder="mm" onChange={(event)=>props.inputChangeHandler(event)} className="form-control1 required"/>
                    </div>
                </div>
                <div className="top-margin10 row">    
                    <div className="col-md-6 ">
                        <div>Refresh Toke Life Time</div>
                        <input type="number" id="rt_h" style={{'width':'70px'}} min="0" name="refreshTokenLifeTime_hh" placeholder="hh" onChange={(event)=>props.inputChangeHandler(event)} className="form-control1 required"/>
                        &nbsp;<input type="number" id="rt_m" style={{'width':'70px'}} min="0" name="refreshTokenLifeTime_mm" placeholder="mm" onChange={(event)=>props.inputChangeHandler(event)} className="form-control1 required"/>                    
                    </div>
                </div>
